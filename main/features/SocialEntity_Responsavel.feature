Feature: Gerenciar Responsavel

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Responsavel
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Responsavel
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Responsavel
