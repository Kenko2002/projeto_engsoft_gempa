Feature: Gerenciar EntidadeSocial

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) EntidadeSocial
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a EntidadeSocial
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a EntidadeSocial
