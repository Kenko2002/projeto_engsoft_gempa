Feature: Gerenciar Fiscal

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Fiscal
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Fiscal
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Fiscal
