Feature: Gerenciar Condicao

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Condicao
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Condicao
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Condicao
