Feature: Gerenciar Vaga

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Vaga
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Vaga
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Vaga
