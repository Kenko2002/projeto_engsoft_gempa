Feature: Gerenciar UnidadeOrganizacional

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) UnidadeOrganizacional
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a UnidadeOrganizacional
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a UnidadeOrganizacional
