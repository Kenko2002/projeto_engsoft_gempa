Feature: Gerenciar Atendimento

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Atendimento
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Atendimento
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Atendimento
