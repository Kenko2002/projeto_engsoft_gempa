Feature: Gerenciar HistoricoCargaHoraria

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) HistoricoCargaHoraria
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a HistoricoCargaHoraria
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a HistoricoCargaHoraria
