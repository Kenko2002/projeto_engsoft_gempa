Feature: Gerenciar Tecnico

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Tecnico
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Tecnico
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Tecnico
