Feature: Gerenciar SetorInstitucional

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) SetorInstitucional
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a SetorInstitucional
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a SetorInstitucional
