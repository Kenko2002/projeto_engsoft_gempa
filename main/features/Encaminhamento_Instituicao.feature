Feature: Gerenciar Instituicao

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Instituicao
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Instituicao
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Instituicao
