Feature: Gerenciar Observacao

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Observacao
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Observacao
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Observacao
