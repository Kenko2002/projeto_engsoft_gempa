Feature: Gerenciar Alocacao

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Alocacao
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Alocacao
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Alocacao
