Feature: Gerenciar Prestador

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Prestador
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Prestador
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Prestador
