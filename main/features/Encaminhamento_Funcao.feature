Feature: Gerenciar Funcao

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Funcao
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Funcao
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Funcao
