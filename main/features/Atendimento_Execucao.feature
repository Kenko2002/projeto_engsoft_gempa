Feature: Gerenciar Execucao

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Execucao
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Execucao
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Execucao
