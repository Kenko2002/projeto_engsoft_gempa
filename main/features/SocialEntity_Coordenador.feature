Feature: Gerenciar Coordenador

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Coordenador
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Coordenador
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Coordenador
